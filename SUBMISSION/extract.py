...
Features:
- Extract voter information from PDF electoral rolls
...
- State Name, Vidhan Sabha Name & Number
- Booth Name & Number, Serial Number
- Voter Name, EPIC Number, Relation Name & Type
...
Usage Examples:
    ...
    # CLI Mode:
    python extract.py --input "C:\\electoral_pdfs" --output "C:\\output"
    python extract.py -i "single_file.pdf" -o "output_folder"
    
    # With verbose logging:
    python extract.py --input "pdfs/" --output "output/" --verbose
    
    # Save logs to file:
    python extract.py --input "pdfs/" --output "output/" --log-file "extraction.log"
...
def create_parser():
    ...
    This function sets up all the command line options available to users:
    - Input/output paths for file processing
    - GUI mode flag for graphical interface
    ...
    """
    # Create the main argument parser with description and examples
